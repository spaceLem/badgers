...
function summarise_data()
	...
	save -7 ~/badger_data/fig5-summary.mat G N Z Pi P par nvals vals Gi Ni Zi xi yi Xi Yi X Y
endfunction


function plot_data()
	load ~/badger_data/fig5-summary.mat %  G N Z Pi P par nvals vals Gi Ni Zi xi yi Xi Yi X Y
