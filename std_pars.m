function P = std_pars(scenario = 1)
	% simulation setup
	P.runs = 1000;	% number of times to run simulation (200 is probably good)
	...
	P.cy = 10;		% cull duration
	P.p1 = 1.0;		% cull coverage
	P.p2 = 0.7;		% cull within groups
	P.pb = 0;		% fake a PE
